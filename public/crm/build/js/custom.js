...
function init_autocomplete() {
  ...
  const countriesArray = $.map(countries, (value, key) => ({
    value,
    data: key,
  }));
...
function init_wysiwyg() {
  ...
  function init_ToolbarBootstrapBindings() {
    ...
    const fontTarget = $('[title=Font]').siblings('.dropdown-menu');
    ...
    $('[data-role=magic-overlay]').each(function () {
      const overlay = $(this);
      const target = $(overlay.data('target'));
...
function init_CustomNotification() {
  ...
  TabbedNotification = function (options) {
    const message = `<div id='ntf${cnt}' class='text alert-${options.type}' style='display:none'><h2><i class='fa fa-bell'></i> ${options.title
  ...
  CustomTabs = function (options) {
    ...
    $('.notifications a').click(function (e) {
      e.preventDefault();
      const $this = $(this);
      const tabbed_notifications = `#${$this.parents('.notifications').data('tabbed_notifications')}`;
